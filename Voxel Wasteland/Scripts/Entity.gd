...
export var should_register = true # whether this entity should register for signals from the world
...
func _ready():
	...
	world.register_entity(self, render_dst, make_chunks_visible) # register the entity with the world
